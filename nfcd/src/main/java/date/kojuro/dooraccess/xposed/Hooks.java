package date.kojuro.dooraccess.xposed;
...
public class Hooks implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(final LoadPackageParam lpparam) throws Throwable {
        ...
        try {
            System.load("/data/app/date.kojuro.dooraccess-1/lib/arm/libnfcgate-native.so");
        } catch(UnsatisfiedLinkError e) {
            try {
                System.load("/data/app/date.kojuro.dooraccess-2/lib/arm/libnfcgate-native.so");
